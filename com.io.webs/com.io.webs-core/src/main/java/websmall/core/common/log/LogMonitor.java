package websmall.core.common.log;
...
public class LogMonitor {
    ...
    @Pointcut("within(websmall..*) || within(org.springframework.boot.autoconfigure.web..*)")
    private void anyMethod() {
    }

    @Pointcut("within(websmall..*) && execution(public void *(..))")
